        ...
        <section className='px-4 lg:px-20 bg-accent py-28 w-full flex justify-center'>
            <div className='lg:flex justify-between items-center space-y-8 gap-x-32'>
                <div className='block'>
                    ...
                    <div className="block"><p className='max-w-xl my-8 text-center lg:text-start mx-auto'>We are currently working on our mobile app which will contain a lot more features that will benefit and satisfy your needs and enhance our services.</p></div>
