    ...
    return (
        <>
            <nav className='flex items-center justify-between lg:justify-end sticky top-0 py-7 lg:py-7 bg-primary'>
                <button className='flex justify-center items-center lg:hidden' type='button' onClick={(e) => handleSidebar()}>
                ...
                <Link className='flex justify-center items-center' href='/admin/settings'>
                    <div className='h-8 w-8 rounded-full bg-accent/80 flex justify-center items-center text-primary mr-2 text-sm'>
            ...
            <Adminbar visible={visible} activate={handleSidebar} />
        </>
    )
}
