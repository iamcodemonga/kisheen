...
const MockDetails = () => {
    return (
        <section className='px-4 lg:px-20 w-full grid grid-cols-2 gap-10 pt-7 pb-20 lg:py-28 items-center'>
            ...
            <div className="col-span-2 lg:col-span-1">
                ...
                <div className='flex space-x-3 my-6'>
                    <span className='h-3 w-28 rounded-lg bg-slate-300/50'></span>
                    <span className='h-3 w-28 rounded-lg bg-slate-300/50'></span>
                </div>
                <div className='h-4 w-full rounded-lg bg-slate-300/50'></div>
                <div className='h-4 w-full rounded-lg bg-slate-300/50 mt-3'></div>
                <div className='h-4 w-3/4 rounded-lg bg-slate-300/50 mt-3'></div>
                <form action="" method="post" className='space-y-5 mt-8'>
                    <div className='flex flex-col'>
                        <div className='h-3 w-28 rounded-lg bg-slate-300/50 mb-2'></div>
