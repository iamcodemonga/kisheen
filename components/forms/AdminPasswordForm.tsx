...
const AdminPasswordForm = ({ id }: Props) => {
    ...
    return (
        <div className="border border-accent rounded-xl mb-10 py-5">
            <div className='flex w-full justify-center'>
                <form action="" onSubmit={(e) => handleSubmit(e)} method="post" className='space-y-8 w-full rounded-lg px-4 py-4 pb-8 lg:p-10'>
                    <h4 className='font-normal mb-5 mt-5 lg:mt-0 text-2xl text-center'>Change Password</h4>
                    ...
                    <div>
                    {loading ? <button type="submit" className=' bg-accent py-4 lg:py-3 w-full md:w-60 rounded-lg text-base font-medium mb-3 mx-auto text-primary'><BeatLoader color="#ffffff" loading={loading} aria-label="Loading Spinner" data-testid="loader" size={10} /></button> : <button type="submit" className=' bg-accent py-4 lg:py-3 w-full md:w-60 rounded-lg text-base font-medium mb-3 mx-auto text-primary'>submit</button>}
                    </div>
                </form>
            </div>
        </div>
