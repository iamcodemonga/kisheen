    ...
    return (
        <section className='flex w-full h-screen'>
            ...
            <main className='w-full lg:ml-60 px-5 overflow-x-hidden'>
                ...
                <h1 className='text-xl lg:text-4xl font-bold mt-7'>Customers Table</h1>
                <section className='my-7 border-2 border-gray-200 rounded-2xl pt-10 pb-5 px-5'>
                    <div className='lg:flex justify-between items-center mb-5'>
                        <h3 className='text-xl font-bold ml-3 mb-5 lg:mb-0'>All Customers</h3>
                        ...
                        <table className='table-auto w-full'>
                            <thead className=''>
                                <tr className="border-b-2 border-gray-200">
                                    ...
                                    <th className='p-3 whitespace-nowrap text-sm'>ID</th>
                            ...
                            <tbody>
                                <tr className='border-b-2 border-gray-200'>
                                    ...
                                    <td className='whitespace-nowrap p-3 text-center'>1672-3642-3785-5468</td>
                                    ...
                                    <td className='whitespace-nowrap p-3 text-center flex items-center justify-center mt-2'>
                                        <span className='bg-green-500 text-xs rounded-md font-bold pt-2 pb-1 px-3 text-primary cursor-pointer mr-3 flex'>
